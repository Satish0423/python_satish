...
if args.operation == "r":
    remote_login = RemoteLogin(
        ...
        args.password,
        args.key,
        "/home/user/remote_login/download_files/",
        "/var/log")
...
if args.operation == "u":
    ...
    remote_login = RemoteLogin(
        ...
        "/home/user/remote_login/download_files/",
        remote_path)
    remote_login.upload_single_file(
        str(input("Give uploaded File with Path:")))
...
if args.operation == "d":
    ...
    remote_login = RemoteLogin(
        ...
        local_path,
        "/var/log")
    remote_login.download_file(
        str(input("Give File downloaded file with Path:")))
